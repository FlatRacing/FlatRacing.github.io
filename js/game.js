...
function Game(nShips, context) {
	...
	this.findWinner = function() {
		if (this.ships.length > 1) {
			...
			screenRight.innerHTML = "<div style=\"display: inline-block; vertical-align: top; margin-right: 5px;\">Share on</div><div style=\"color: #919191; display: inline-block; vertical-align: top; text-align: left; margin-left: 5px;\"><div>/ <a href=\"/sharer.php?app_id=643746005713643&amp;sdk=joey&amp;u=http%3A%2F%2Fflatracing.github.io%2F&amp;display=popup&amp;ref=plugin\" target=\"_blank\" style=\"color: #3b5998;\">Facebook</a></div><div>/ <a href=\"https://twitter.com/intent/tweet?original_referer=&text=I%20just%20scored%20" + this.ships[0].score + "%20at%20%23Fltracing,%20try%20to%20beat%20me%20on:%20http%3A%2F%2Fflatracing.github.io%2F\" target=\"_blank\" style=\"color: #34beda;\">Twitter</a></div></div>"
		}
	};
